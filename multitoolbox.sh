...
if ! [[ -z $1 ]]; then
	...
	bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/$ROOT_BRANCH/multitoolbox.sh) $ROOT_BRANCH $2
	unset ROOT_BRANCH
...
function install_node(){
	...
	bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/${ROOT_BRANCH}/install_pro.sh)
}
...
if [[ $(cat /etc/bash.bashrc | grep 'multitoolbox' | wc -l) == "0" ]]; then
	echo "alias multitoolbox='bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/master/multitoolbox.sh)'" | sudo tee -a /etc/bash.bashrc
	echo "alias multitoolbox_testnet='bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/master/multitoolbox_testnet.sh)'" | sudo tee -a /etc/bash.bashrc
	alias multitoolbox='bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/master/multitoolbox.sh)'
	alias multitoolbox_testnet='bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/master/multitoolbox_testnet.sh)'
