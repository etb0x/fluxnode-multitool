...
#
#   Usage:
#   bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/development/cdn-speedtest.sh) "<test_time_in_s>" "<file_name>" "<array_url_list_via_export>" 
#
...
#   bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/development/cdn-speedtest.sh) "6" "flux_explorer_bootstrap.tar.gz" "${list[@]}"
#
#   Example 2 ( for testing cdn with 6s download test of each server )
#   bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/development/cdn-speedtest.sh) "6"
#
#   Example 3 ( for testing cdn with default settings )
#   bash -i <(curl -s https://raw.githubusercontent.com/etb0x/fluxnode-multitool/development/cdn-speedtest.sh)
#
#
#color codes
YELLOW='\033[1;33m'
